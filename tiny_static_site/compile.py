...
def run():
    ...
    jinja_env.globals.update(css_url_for=get_js_css_url_for_func(source_assets_dir, assets_dir, assets_url, 'css'))
    jinja_env.globals.update(js_url_for=get_js_css_url_for_func(source_assets_dir, assets_dir, assets_url, 'js'))
